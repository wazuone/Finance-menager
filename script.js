...
let root = document.documentElement // bedziemy mogli odwoływać się do elementu root
let ID = 0
let categoryIcon
...
const clearInputs = () => {
	//	// po zamknięciu okna z nową transakcją, usuwa wszystkie inputy aby przy ponownym otwarciu nie było starych zapisów
	nameInput.value = ''
	amountInput.value = ''
...
const createNewTransaction = () => {
	...
	moneyArr.push(parseFloat(amountInput.value)) // przekonwertowanie stringu w liczby // parseFloat uwzględnia liczby po przecinku
